document.addEventListener('DOMContentLoaded', function() {
    // Create the navbar HTML with inline styles for stickiness
    const navbarHTML = `
    <nav style="
        position: fixed; 
        top: 20px; 
    ...
    // Find the placeholder element for the navbar
    ...
    if (navbarPlaceholder) {
        ...
        // Add a larger margin below the placeholder to prevent content from going behind the fixed navbar
        navbarPlaceholder.style.marginBottom = "120px";
        
        // Add padding to the top of the body for better spacing
        document.body.style.paddingTop = "20px";
        
        // Create a script element for toggle.js
        const toggleScript = document.createElement('script');
        toggleScript.src = 'toggle.js';
        
        // Wait for the toggle script to be loaded before continuing
        toggleScript.onload = function() {
            // Once toggle.js is loaded, initialize the theme
